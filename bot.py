...
class Client(commands.Bot):
    def __init__(self):
        ...
        self.cogslist = ["Commands.hello","Commands.status","adminCommands.remove_messages","passiveCommands.message_filtering", "passiveCommands.response_to_messages", "adminCommands.soft_ban", "adminCommands.natural_language","adminCommands.timeout"]
        self.db = dbAccess.db
